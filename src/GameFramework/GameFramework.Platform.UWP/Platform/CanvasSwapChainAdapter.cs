...
namespace GameFramework.Platform
{
    public class CanvasSwapChainAdapter : ISwapChain
    {
        ...
        {
            var canvasDrawingSession = this.canvasSwapChain.CreateDrawingSession(Colors.CornflowerBlue);
        ...
        public void CreateSwapChain()
        {
            ...
            CoreWindow coreWindow = ((CoreWindowAdapter)this.platformWindow).Window;
            ...
            // TODO Need to solve this better
            this.Target = this;
        }
    }
}
